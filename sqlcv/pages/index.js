...
export default function Home() {
  return (
    <div class="container bg-gradient-to-r from-indigo-800 via-purple-800 to-pink-500 min-h-screen max-w-screen-xl grid grid-cols-6 row-6">
      <div class="bg-gradient-to-r from-blue-400 to-blue-600 col-span-6 space-x-24">
      ...
      <div class="col-span-3 row-span-4 pl-14">
      ...
      <div class="col-span-6 bg-gradient-to-r from-blue-400 to-blue-600">
        footer
      </div>
    </div>
  );
